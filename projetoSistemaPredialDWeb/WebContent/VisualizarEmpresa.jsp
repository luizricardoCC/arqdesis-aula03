...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Sistema Predial - Visualizar Empresa</title>
        ...
        <body>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="controller.do" method="post">
                                    <input type="hidden" name="cnpj_excluir" value="${empresa.cnpj }" />
                ...
                <div id="main" class="container">
                    <h3 class="page-header">Visualizar Empresa #${empresa.cnpj }</h3>
                    <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div id="actions" class="row">
                        <div class="col-md-12">
                            <a href="controller.do?command=EditarEmpresa&cnpj=${empresa.cnpj }" class="btn btn-primary">Editar</a>
